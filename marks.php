            ...
            <div class="container-fluid">
                ...
                <div class="form-group">  
                     <form name="add_name" id="add_name">  
                          ...
                          <h2 class="heading text-info"><?php echo"Student Selected: $num"; ?> </h2> <br/> 

                               <table class="table table-bordered" id="dynamic_field">                                 
                                    <tr>  
                                         <td><h2 class="heading text-center text-primary mark">Theory</h2></td>  
                                    </tr>  
                                    <tr>
                                    ...
                                    <tr>  
                                         <td><h2 class="heading text-center text-primary mark">Practical</h2></td>  
                                    </tr>  
                                    <tr>
                                        <td><input type="text" name="name2[]" placeholder="Enter Marks" class="form-control name_list" /></td>  
                                    </tr>
                                    ...
                                    <tr>  
                                         <td><h2 class="heading text-center text-primary mark">Viva</h2></td>  
                                    </tr>  
                                    <tr>
                                        <td><input type="text" name="name2[]" placeholder="Enter Marks" class="form-control name_list" /></td>  
                                    </tr>
