    ...
    <div class="main-panel">
        ...
        <div name="list" id="name" class="table table-striped table-bordered table-hover table-responsive-lg overflow-auto">
            ...
            <form action="reg_form.php" method="POST">
                ...
                <input type="text" id="number" class="form-control name_list" pattern=".{10,}" required title="10 characters minimum" name="number" placeholder="Type Student Mobile No."> 
                <br/>
                <input type="submit" id="submit" class="btn btn-primary align-center">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="https://portala.info">Portala Inc.</a>,Code Online
                </p>
            </div>
        </footer>
