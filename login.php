	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="test.php">
					<span class="login100-form-title p-b-32">
						Login To Verify Registration <p><br/>(* पंजीकरण करने के लिए लॉग इन करें *)</p>
					</span>
					<span>Enter User -> 2222 for admin Panel</span>
					<span>Enter User -> 3245 for student Panel</span>
...
<!--===============================================================================================-->
	...
	<div id="footer">
            <a href="https://portala.tech" id="footer" style="color: #fff;" target="_blank">Website By Portala Inc. COPYRIGHT © PORTALA INC. | World Fastest Online IDE</a>
    </div>
</body>
</html>