	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="marksheet.php">
					<span class="login100-form-title p-b-32">
						View Result <p><br/>(* परिणाम देखने के लिए लॉग इन करें *)</p>
					</span>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Mobile Number is required">
						<input class="input100" type="text" name="number" placeholder="Your Registered Number" maxlength="11" pattern=".{10,}" required title="10 characters minimum" >
